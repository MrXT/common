...
public class ErrorCodeController implements ErrorController {
    ...
    public Object error404() {
        throw new BusinessException(statusMap.get(SystemConstant.NOT_FOUND));
    ...
    public Object error405() {
        throw new BusinessException(statusMap.get(SystemConstant.METHOD_NOT_ALLOWED));
    }
    /**
     * 405
     * @return
    ...
    public Object error500(String message) {
    ...
    public Object error400() {
        throw new BusinessException(statusMap.get(SystemConstant.BAD_REQUEST));
