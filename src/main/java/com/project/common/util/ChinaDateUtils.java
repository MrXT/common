/**
 * Project Name:epad File Name:test.java Package
 * Name:com.manzz.framework.core.util Date:2014年9月3日上午9:28:00 Copyright (c)
 * 2014, manzz.com All Rights Reserved.
 */

package com.project.common.util;

/**
 * ClassName: ChinaDate <br/>
 * Function: 阳历转阴历. <br/>
 * @author XT
 * @version 2014年9月3日
 */
...
public class ChinaDateUtils {
    final private static long[] lunarInfo = new long[] { 0x04bd8, 0x04ae0, 0x0a570, 0x054d5, 0x0d260, 0x0d950, 0x16554, 0x056a0, 0x09ad0, 0x055d2,
...
//    private final static String[] solarTerm = new String[] { "小寒", "大寒", "立春", "雨水", "惊蛰", "春分", "清明", "谷雨", "立夏", "小满", "芒种", "夏至", "小暑", "大暑",
//        "立秋", "处暑", "白露", "秋分", "寒露", "霜降", "立冬", "小雪", "大雪", "冬至" };
//
//    private final static String[] sFtv = new String[] { "0101*元旦", "0214 情人节", "0308 妇女节", "0312 植树节", "0315 消费者权益日", "0401 愚人节", "0501 劳动节",
//        "0504 青年节", "0512 护士节", "0601 儿童节", "0701 建党节", "0801 建军节", "0808 父亲节", "0909 毛泽东逝世纪念", "0910 教师节", "0928 孔子诞辰", "1001*国庆节", "1006 老人节",
//        "1024 联合国日", "1112 孙中山诞辰", "1220 澳门回归", "1225 圣诞节", "1226 毛泽东诞辰" };
//
//    private final static String[] lFtv = new String[] { "0101*农历春节", "0115 元宵节", "0505 端午节", "0707 七夕情人节", "0815 中秋节", "0909 重阳节", "1208 腊八节",
//        "1224 小年", "0100*除夕" };
     ...
     * @return
     */
    final public static long[] lunar(int y, int m) {
    ...
    public static Date getLunarDate(Date date) {
        ...
        if(l[1]>9){
            ...
            strDate += l[0] + "-0" + l[1] + "-" + l[2];
        }
        Date lunarDate = null;
        try {
            lunarDate = DateUtils.parseShortDateString(strDate);
    ...
    public static void main(String[] args) {
        System.out.println(ChinaDateUtils.getLunarDate(new Date()));
        //农历甲午(马)年八月初十
        //农历2014年八月
        
//        long[] lar = lunar(2014,9);
//        for(long l : lar){
